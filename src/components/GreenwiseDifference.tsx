...
const features = [
  {
    icon: <FaGlobe className="text-4xl text-green-800 mx-auto mb-4" />,
    title: "Responsible Travel",
    desc: "We exist for 3 missions: happy traveller, better environment and empowered communities.",
  },
  {
    icon: <FaTrophy className="text-4xl text-green-800 mx-auto mb-4" />,
  ...
  {
    icon: <FaHandsHelping className="text-4xl text-green-800 mx-auto mb-4" />,
    title: "Impact That Counts",
    desc: "Travel with us to make a positive impact at no extra cost.",
  },
  {
    icon: <GiHiking className="text-4xl text-green-800 mx-auto mb-4" />,
  ...
  {
    icon: <FaMap className="text-4xl text-green-800 mx-auto mb-4" />,
    title: "Bespoke Itineraries",
    desc: "We tailor our safaris to your unique needs, even on scheduled or group tours.",
  },
  {
    icon: <FaHeart className="text-4xl text-green-800 mx-auto mb-4" />,
