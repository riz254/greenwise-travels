...
export default function Footer() {
  return (
    <footer
      className="site-footer bg-gray-100 !p-16 max-w-fit"
    >
      <div className="">
        <div className=" mx-auto px-6">
<div className="flex flex-wrap text-center md:text-left justify-between gap-y-20 ">
            {/* Vision + Mission */}
            <div className="w-full md:w-5/12 mt-5">
              <div className="">
                <h3 className="  ">Our Vision</h3>
                <p className="!my-6 text-amber-100">
              ...
              <div className="widget">
                ...
                <ul className="!space-y-4 text-gray-700">
                  ...
                  <li className="flex items-start gap-3 text-white">
                    <FaMarker className="text-green-600 " />
                    
                      6th Floor, Utumishi Co-op House, Mamlaka Road 
