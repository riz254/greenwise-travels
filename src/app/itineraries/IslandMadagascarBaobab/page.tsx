        ...
        <main className="flex-1 !px-4 md:!px-10 !mt-20 overflow-x-hidden">
          <section id="overview">
            ...
            <p className="text-gray-700 leading-relaxed text-justify">
              This fly-in safari takes you to Madagascar&apos;s iconic Baobab
              Alley and Tsingy de Bemaraha National Park. Explore the
              picturesque avenue of ancient baobabs, some over 800 years old,
              and enjoy a breathtaking aerial view of Tsingy&apos;s dramatic
              limestone pinnacles.
              <br />
