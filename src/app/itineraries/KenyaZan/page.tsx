        ...
        <main className="flex-1 !px-4 md:!px-10 !mt-20 overflow-x-hidden">
          <section id="overview">
            <h2 className="text-3xl md:text-4xl font-bold text-green-800 !mb-4">
              KENYA - ZANZIBAR LUXURY HONEYMOON TOUR{" "}
            </h2>
            <p className="text-gray-700 leading-relaxed text-justify">
              Get ready for an unforgettable journey through Kenya and Zanzibar,
              where you’ll experience the magic of East Africa with your loved
              one. Begin with a breathtaking safari in the Masai Mara,
              witnessing Kenya’s incredible wildlife, followed by pure
              relaxation on the dreamy beaches of Zanzibar. Stay in some of the
              finest safari lodges and beach resorts, perfectly tailored for
              romance. From a sunrise hot air balloon flight to a romantic beach
              dinner under the stars, we’ll curate unique experiences just for
              you. Your private, luxury Kenya Zanzibar Honeymoon will redefine
              romance and immerse you in the heart of Africa.
            </p>
          </section>
