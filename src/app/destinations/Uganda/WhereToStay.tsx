...
const stays = [
  {
    name: "Bwindi Impenetrable Forest Lodge",
    image: "/images/images/BwindiLounge.jpg",
    description:
      "Located on the edge of Bwindi Impenetrable Forest, this lodge offers stunning views, luxury accommodations, and proximity to gorilla trekking adventures.",
  },
  {
    name: "Katara Lodge",
    image: "/images/images/Katara_lodge2.jpg",
    description:
      "Perched on the edge of the scenic Katonga Wildlife Reserve, Katara Lodge features luxurious accommodations and breathtaking views of the surrounding landscapes.",
  },
  {
    name: "Mihingo Lodge",
    image: "/images/images/MihingoLounge.jpg",
    description:
      "Perched on a rocky outcrop near Lake Mburo National Park, Mihingo Lodge offers luxurious tented accommodations with panoramic views and great wildlife experiences.",
  },
  {
    name: "Kyaninga Lodge",
    image: "/images/images/KyaningaLounge.jpg",
    description:
      "Perched on the edge of a volcanic crater lake near Fort Portal, Kyaninga Lodge features breathtaking views, luxurious tents, and a relaxing atmosphere.",
  },
  {
    name: "Paraa Safari Lodge",
    image: "/images/images/paaraLounge.jpg",
    description:
      "Situated in the heart of Murchison Falls National Park, this lodge offers classic safari experiences with spacious rooms and views of the Nile River.",
  },
];
