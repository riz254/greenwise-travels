...
const stays = [
  {
    ...
    description:
      "Experience the thrill of wildlife right from your doorstep at this lodge, offering luxurious accommodations with easy access to prime game viewing.",
    image: "/images/images/KrugerLonge.png",
  },
  {
    name: "Angala Boutique Hotel",
    description:
      "Nestled in the Cape Winelands, this boutique hotel combines luxury with nature, offering stunning views and personalized service.",
    image: "/images/images/Angala-Brand-Image-Full-scaled.jpg",
  },
  {
    name: "Sabi Sands Game Reserve Lodge",
    description:
      "Known for its exceptional wildlife sightings, this exclusive lodge provides a luxurious safari experience with private game drives.",
    image: "/images/images/outside-view-earth-lodge-sabi-sabi.jpg",
  },
  {
    name: "Okavango Delta Camp",
    description:
      "Stay in a unique tented camp surrounded by water, offering mokoro rides and bush walks for an immersive safari experience.",
    image: "/images/images/OkavangoDelta-Camp_-main-lodge-scaled.jpg",
  },
  {
    name: "Victoria Falls Safari Lodge",
    description:
      "Overlooking the Zambezi River, this lodge offers stunning views, luxury accommodations, and easy access to the iconic falls.",
    image:
      "/images/images/Victoria-Falls-Safari-Lodge-Victoria-Falls-Zimbabwe-scaled.jpg",
  },
];
